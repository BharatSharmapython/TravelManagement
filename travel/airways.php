...
$sql = "INSERT INTO book_plane ( c_id , p_id, book_id) VALUES
            ( '$id' , '$tid' ,'$bid')";
...
if($link-> query($sql) == TRUE)
{
    ...
    echo '<a href="http://localhost/travel/planepayment.html" class="btn btn-outline-danger">MAKE PAYMENT</a>';
} 
else
{
    echo "<font size=+3>FAILED!!<br> PLEASE TRY AGAIN <br><br>";
   
    echo '<a href="http://localhost/travel/airways.html" class="btn btn-outline-danger">TRY AGAIN</a>';
