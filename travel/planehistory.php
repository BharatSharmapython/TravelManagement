<html>
    ...
    <body background="images/air.jpg" class="text-center">
      ...
      <h3 class="text-center display-1">KNOW FLIGHT BOOKING DETAILS</h3><BR><BR>
...
$sql = "SELECT * FROM book_plane where c_id = $id";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo " <font size=+3 color=blue> <tr style='font-weight:bold'> <td> " . $row["c_id"]."</td>" ." <td> " . $row["p_id"]. "</td>" ." <td> " . $row["book_id"]."</td>";
           }
